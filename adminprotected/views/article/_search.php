...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textArea($model,'content',array('class'=>'ckeditor', 'id'=>'editor1', 'rows'=>10, 'cols'=>80)); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->fileField($model,'file',array('onclick'=>'checkFile()')); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'category_id'); ?>
		<?php echo $form->dropDownList($model,'category_id',$categorys); ?>
	</div>
